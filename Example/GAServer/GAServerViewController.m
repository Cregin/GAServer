...
//    GAServerGetCityWeatherByIdRequest * request = [[GAServerGetCityWeatherByIdRequest alloc]initWithcityId:@"101010100" userId:@"20567040"];
//    [request startWithCompletionBlockWithSuccess:^(__kindof YTKBaseRequest * _Nonnull request) {
//        
//    } failure:^(__kindof YTKBaseRequest * _Nonnull request) {
//        
//    }];
    ...
    GAServerGetCityWeathersByIdsRequest * request = [[GAServerGetCityWeathersByIdsRequest alloc]initWithcityIdArray:@[@"101110101",@"101010100"]];
    [request startWithCompletionBlockWithSuccess:^(__kindof YTKBaseRequest * _Nonnull request) {
